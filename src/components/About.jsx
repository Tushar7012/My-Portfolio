...
// --- Skill Icons ---
const PythonIcon = () => (
  <svg className="w-8 h-8" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg"><path fill="#306998" d="M57.981 128H28.633a10.42 10.42 0 0 1-10.42-10.42V88.233h39.768a10.42 10.42 0 0 0 10.42-10.42V10.42A10.42 10.42 0 0 1 78.821 0h19.812a10.42 10.42 0 0 1 10.42 10.42v29.348H70.285a10.42 10.42 0 0 0-10.42 10.42v38.045a10.42 10.42 0 0 1-10.42 10.42H28.633v18.907a10.42 10.42 0 0 0 10.42 10.42h18.928z"/><path fill="#FFD43B" d="M70.019 0h29.348a10.42 10.42 0 0 1 10.42 10.42v29.348H70.019a10.42 10.42 0 0 0-10.42 10.42v67.392A10.42 10.42 0 0 1 49.179 128H29.367a10.42 10.42 0 0 1-10.42-10.42V88.233h39.768a10.42 10.42 0 0 0 10.42-10.42V10.42A10.42 10.42 0 0 1 79.255 0h-9.236z"/><circle cx="48.962" cy="10.839" r="10.839" fill="#fff"/><circle cx="79.038" cy="117.161" r="10.839" fill="#fff"/></svg>
);
const TensorFlowIcon = () => (
    <svg className="w-8 h-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#FF6F00" d="M12.13 14.89l-2.1 2.1-5.04-5.05 2.1-2.1 2.94 2.95zm4.24-4.24l2.1-2.1-5.04-5.05-2.1 2.1 5.04 5.05zm-8.48 0l-2.1 2.1-2.9-2.9 2.1-2.1 2.9 2.9zM12 22.45l-5.04-5.04 2.1-2.1 2.94 2.94 2.94-2.94 2.1 2.1-5.04 5.04zM14.89 9.81l-2.1-2.1-2.9 2.9 2.1 2.1 2.9-2.9z"/></svg>
);
const DockerIcon = () => (
    <svg className="w-8 h-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#2496ED" d="M22.1 8.25c-.33-1.92-1.3-3.6-2.6-4.82a7.66 7.66 0 0 0-5.35-2.23H4.85c-.3 0-.55.25-.55.55v2.75c0 .3.25.55.55.55h10.45c1.65 0 3 1.35 3 3s-1.35 3-3 3H3.85c-.3 0-.55.25-.55.55v2.75c0 .3.25.55.55.55h9.9c1.65 0 3 1.35 3 3s-1.35 3-3 3H2.85c-.3 0-.55.25-.55.55V21.2c0 .3.25.55.55.55h7.3c2.05 0 3.95-.8 5.35-2.23 1.3-1.22 2.27-2.9 2.6-4.82.25-1.4.25-2.85 0-4.25zM8.85 7.2h-3V5h3v2.2zM12.4 7.2h-2.7V5h2.7v2.2zM8.85 12h-3V9.8h3V12z"/></svg>
);
const AWSIcon = () => (
    <svg className="w-8 h-8" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#FF9900" d="M12.3 14.5c-1.8-1.1-3-2.6-3.8-4.3h7.1c-.2.6-.5 1.1-.9 1.6-1.1 1.2-2.5 1.8-4.4 2.7zm-2.8-5.3c.1-.2.2-.4.3-.6.8-1.3 2-2.3 3.5-2.9.2-.1.4-.1.6-.2-2.3-.2-4.4 1.1-5.5 3.1-.1.2-.2.4-.3.6h1.4zM21.9 13c-.3 1.9-1.2 3.6-2.5 4.9-1.5 1.5-3.5 2.4-5.7 2.4-2.7 0-5.1-1.3-6.6-3.4-.1-.2-.2-.4-.3-.6l1.3-.8c.1.2.2.4.4.6 1.1 1.5 2.8 2.4 4.7 2.4 1.6 0 3.1-.6 4.2-1.7s1.7-2.6 1.7-4.2c0-1.1-.3-2.1-.9-3-.4-.6-.9-1.1-1.5-1.5-1.7-1.1-3.7-1.3-5.6-.6-1.1.4-2.1 1.1-2.9 2-.5.5-.9 1.1-1.2 1.8h-.1c-.1-.3-.1-.6-.1-.9 0-2.3 1.2-4.3 3-5.5 1.6-1.1 3.5-1.5 5.4-1.2.2 0 .4 0 .6.1.2 0 .4.1.6.1 1.7.3 3.2 1.2 4.2 2.6.8 1.1 1.3 2.4 1.3 3.8 0 .3 0 .6-.1.9z"/></svg>
);
  ...
  return (
    <section id="about" className="min-h-screen w-full bg-black text-white py-20 px-6 md:px-12">
      <div className="container mx-auto">
        ...
        {/* --- UPDATED: Skills Section in a 2x3 Matrix --- */}
        <motion.div 
          initial={{ opacity: 0 }}
          ...
          className="mb-24"
        >
          <h3 className="text-3xl font-bold text-center mb-8 text-white">My Tech Stack</h3>
          {/* Using a grid with 3 columns for the matrix layout */}
          <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
            {skills.map((skill, index) => (
              <div key={index} className="group flex items-center justify-center gap-4 p-4 bg-black/50 border border-white/10 rounded-lg transition-all duration-300 hover:border-purple-500 hover:bg-purple-900/20">
                {skill.icon}
                <span className="text-md font-medium text-white/80 transition-colors duration-300 group-hover:text-white">{skill.name}</span>
              </div>
            ))}
          </div>
        </motion.div>
